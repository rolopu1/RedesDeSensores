...
void Decision(){
  ...
  if(max_aX >1.5 && min_incgX < -450 && min_incgY < -450 && max_incgZ > 450){
    Serial.println("Mate");
    golpe = 0x01;
  }
  else if(max_aX > 1.5 && min_gY < -200 && max_incgX > 300 && max_incgZ < 250){
    Serial.println("Derecha");
    golpe = 0x02;
  }
  else if(min_aZ < -0.5 && min_gY > -200 && max_incaY > 200 && max_incgY > 200){
    Serial.println("Corte");
    golpe = 0x03;
  }
  else if(max_aX < 1.5 && min_aY < -1.5 && min_aZ < -1.5 && max_incaZ > 300 && max_incaX > 100){
