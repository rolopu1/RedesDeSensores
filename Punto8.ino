...
//Adafruit_MQTT_Subscribe temperatureRead = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/punto8");
...
void setup(){
  ...
  delay(500);
  //mqtt.subscribe(&temperatureRead);
}
...
void loop()
{
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    if (subscription == &temperatureRead) {
      Serial.println((char *)temperatureRead.lastread);
    }
  }
  */
